...
In figure \ref{result_toilet_linear_1_05_02_01_001}, you can see the results of choosing a linear function from 0 to 0.2 as the goal probability function. We can see here that the pedestrians reach their goal very early, that is, 100 \% of the pedestrians reach the goal so early, they could easily have used the remaining time to do a multitude of other activities.

\todo[inline]{Aggegrate graphs}
\begin{figure}
\centering
\includegraphics[width=250pt]{/allautomaticresults/result_toilet_linear_1_05_02_01_001.png}
\caption{result_toilet_linear_1_05_02_01_001}
