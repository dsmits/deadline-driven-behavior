...
The results are different from what we expected, but logical nontheless. We expected the sigmoid function to have the ideal curve to reflect the behavior of the pedestrians in Rotterdam airport but 
