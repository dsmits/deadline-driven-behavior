...
\todo[inline]{Where has this experiment gone? Is it enough to point out certain behaviors in the annotated data and imitate those in the simulation?}
First of all, we will see if it is possible to recreate real-life behavior in Rotterdam airport with our framework. In order to do this, we have observed footage from the security cameras 
...
\begin{equation}
U(t) = \eta \frac{1}{1+e^{-\omega(t-t_0)}}
\end{equation}
