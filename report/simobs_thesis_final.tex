...
If $t<n$: $P(t) = P(n)$
\end{center}
However, we do not specify these parameters directly. What matters the most to us, is the value at the start of the linear utility function, $U$ at \todo[inline]{Name t differently}$t=0$, which we call $U_0$ and the value of $U$ at the end where $t=n$, which we call $U_n$. Consequently, we compute $a$ and $b$ as follows:
