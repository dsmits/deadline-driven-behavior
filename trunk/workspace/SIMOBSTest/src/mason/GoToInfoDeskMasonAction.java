...
public class GoToInfoDeskMasonAction extends AbstractBaseMasonAction {
    private static final int GOAL_LOCATION_X = 35;
    private static final int GOAL_LOCATION_Y = 10;
    private static final int MARGIN = 1;
    private double speed;

    public GoToInfoDeskMasonAction() {
        speed = DEFAULT_SPEED;
    }
