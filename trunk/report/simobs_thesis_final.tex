...
\chapter{Experiments}
\todo[inline]{A lot needs to change here, maybe remove the old experiments with the graphs completely}
...
\todo[inline]{In the process of fixing the code, we also got rid of all the basic wander behavior in the basic pedestrian Petri net. Should I modify the previous experiments or just say that we changed that for the last experiment?}
...
%\end{figure}
\todo[inline]{At this place there were previously a lot of graphs that I now commented out. Decide what to do with them. I shouldn´t put them in my thesis in this form.}
