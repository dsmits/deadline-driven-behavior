...
\todo[inline]{Introduce Petri nets}
...
\todo[inline]{Maybe put the explanation of the difference between actions aan behaviors at an earlier place?}
...
\chapter{Experiments}
\todo[inline]{Redo experiments with new method done in latest experiment.}
...
\todo[inline]{Are all behaviors still in use?}
...
It is very difficult to quantitatively establish whether lifelike behavior has been modeled. However, it is possible to check whether the mechanics of time planning work as predicted. In order to do this, we log for every step 
...
We added the slowwander and fastwander situations in small blocks to the simulation, in such a way that the entire simulation area is covered with both situations. The reason that we did not make two big situations, is that when a token of a pedestrian leaves a situation, it is disconnected from it. \todo[inline]{This is not entirely true any more, I think it only counts for shared situations, maybe I can try to run the simulation again with only two big blocks of fastwander and slowwander situations and see if it behaves the same. It would save a lot of time with the loading of the situations in the beginning.}
...
Firstly we are going to discuss the results of the first quantitative experiment. We can see that in general, we have chosen the right parameters to make the pedestrians reach their goal in time.

One problem with these results however is that the number of pedestrians going to their goal goes up very fast from a certain point in time, regardless of the exact shape of the utility function. Consequently it is quite difficult to see if relaxed and hurried behavior actually emerges from our framework. That was why we decided to do the second quantitative experiment that we described in the previous chapter (\ref{sec:quantitativeexp2}).


%Pictures \ref{fig:gaussian200_50_1_goal01to0} \ref{fig:gaussian200_50_1_goal1to0} \ref{fig:gaussian200_50_1_goalgaussian0_50_1} \ref{fig:gaussian200_50_1_goalsigmoid_100_0_-1_1} \ref{fig:linear0_1_200_goalgaussian_0_50_1} \ref{fig:linear0_1_200_goalsigmoid_100_0_-10_1} \ref{fig:linear0to1_goal01to0} \ref{fig:linear0to1_goalsigmoid_100_0_10_01} \ref{fig:linear0to1goal01} \ref{fig:linear0to1goal01} \ref{fig:linear0to1goal1to0} \ref{fig:linear0to1goal1} \ref{fig:sigmoid100_0_10_1_goal1to0} \ref{fig:sigmoid100_0_10_1_goalgaussian0_50_1} \ref{fig:sigmoid100_0_10_1_goalsigmoid100_0_-10_1} \ref{fig:sigmoid100_0_10_1_goalsigmoid100_0_10_-1} \ref{fig:sigmoid_100_0_10_1_goal_100_0_10_01} \ref{fig:sigmoid_100_0_10_1_goal_100_0_10_01}.

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to1goal1.png}
\caption{linear0to1goal1}
\label{fig:linear0to1goal1}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to1goal01.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to1goal1to0.png}
\caption{linear0to1goal1to0}
\label{fig:linear0to1goal1to0}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/gaussian200_50_1_goal1to0.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/gaussian200_50_1_goal01to0.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to1_goal01to0.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid100_0_10_1_goal1to0.png}
\caption{sigmoid100 0 10 1 goal1to0}
\label{fig:sigmoid100_0_10_1_goal1to0}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid_100_0_10_1goal01to0.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid_100_0_10_1_goal_100_0_10_01.png}
\caption{sigmoid 100 0 10 1 goal 100 0 10 01}
\label{fig:sigmoid_100_0_10_1_goal_100_0_10_01}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to1_goalsigmoid_100_0_10_01.png}
\caption{linear0to1 goalsigmoid 100 0 10 01}
\label{fig:linear0to1_goalsigmoid_100_0_10_01}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid100_0_10_1_goalsigmoid100_0_10_-1.png}
\caption{sigmoid100 0 10 1 goalsigmoid100 0 10 -1}
\label{fig:sigmoid100_0_10_1_goalsigmoid100_0_10_-1}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/gaussian_200_50_1_goalsigmoid_100_0_10_-1.png}
\caption{gaussian 200 50 1 goalsigmoid 100 0 10 -1}
\label{fig:gaussian_200_50_1_goalsigmoid_100_0_10_-1}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/gaussian200_50_1_goalsigmoid_100_0_-1_1.png}
\caption{gaussian200 50 1 goalsigmoid 100 0 -1 1}
\label{fig:gaussian200_50_1_goalsigmoid_100_0_-1_1}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0_1_200_goalsigmoid_100_0_-10_1.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid100_0_10_1_goalsigmoid100_0_-10_1.png}
\caption{sigmoid100 0 10 1 goalsigmoid100 0 -10 1}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid100_0_10_1_goalgaussian0_50_1.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0_1_200_goalgaussian_0_50_1.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/gaussian200_50_1_goalgaussian0_50_1.png}
...
\todo[inline]{Maybe the pictures are better next to eachother or something.}
...
\begin{figure}
\centering
\includegraphics[width=1.3\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/constant1_cropped}
\caption{constant1}
\label{fig:constant1}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to1_100agents.png}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to05_100agents.png}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/linear0to01_100agents.png}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoidnotmultiplied_100agents.png}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid xtimes20.png}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/sigmoid xtimes100.png}
...
\begin{figure}
\centering
\includegraphics[width=1.5\textwidth]{/home/djura/vakken/svn_afstudeerstage/deadline-driven-behavior/hulpscriptjes/goodresults/gaussian_mean200_sigma50_100_max1.png}
